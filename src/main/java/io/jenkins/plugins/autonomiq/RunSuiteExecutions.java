...
class RunSuiteExecutions {
    ...
    public Boolean runSuites(String platform,
                             ...
                             String browserVersion, String platformVersion, String sauceConnectProxy,
                             String mobileplatformTestSuites, String mobilePlatformVersion, String deviceName,
                             String mobileSauceConnectProxy, String mobileExecutionMode, String deviceOrientation,
                              String enableAnimations, String autoGrantPermission,
                              Boolean mobileDevice, Boolean crossBrowser, String value) throws PluginException, InterruptedException {
    ...
    private Boolean handleSuiteExecutions(String platform, String browser, String executionMode,
                                           String environmentType, String browserVersion, String platformVersion,
                                            String sauceConnectProxy, String mobileplatformTestSuites,
                                            String mobilePlatformVersion, String deviceName, String mobileSauceConnectProxy,
                                            String mobileExecutionMode,String deviceOrientation,
                                            String enableAnimations,String autoGrantPermission,
                                            Boolean mobileDevice,Boolean crossBrowser,String value) throws PluginException, InterruptedException {
        log.println();
